...
const projects = [
    { name: "Casey’s Distributing", url: "https://www.caseys-distributing.com/", desc: "B2B BigCommerce wholesale storefront supporting thousands of resellers, 50+ manufacturers, and more than 50,000 products.", features: "Wholesale purchasing, bulk catalogue management, custom product fields, spreadsheet imports, reseller functionality." },
    { name: "BB Wheels Online", url: "https://www.bbwheelsonline.com/", desc: "Large automotive BigCommerce catalog with vehicle-based product discovery and dealer pricing.", features: "Searchspring filtering, vehicle search, NetSuite via Celigo, customer groups, dealer pricing, B2B discounts, BNPL." },
    { name: "Woodworking Shop", url: "https://www.woodworkingshop.com/", desc: "BigCommerce woodworking store with approximately 13,000 products.", features: "Advanced navigation, search, filtering, shipping rules, Google Shopping integration, automated feed management." },
    { name: "Regal Fish", url: "https://regalfish.co.uk/", desc: "Combined B2C and B2B seafood commerce platform.", features: "Wholesale pricing, customer-specific catalogs, quotation workflows, company-account hierarchy, sales-rep management." },
    { name: "Andover Fabrics", url: "https://www.andoverfabrics.com/", desc: "B2B fabric ordering portal.", features: "Customer-specific pricing, inventory visibility, pre-orders, wholesale ordering, Acumatica integration." },
    { name: "Indigo Fragrance", url: "https://indigofragrance.com/", desc: "Hybrid B2C and B2B fragrance commerce store.", features: "Product variants, online payments, ShipStation integration, Trustpilot integration, Google Analytics." },
    { name: "Envision Xpress", url: "https://www.envisionxpress.com/", desc: "Multi-channel commerce platform supporting government, military, business, and retail buyers.", features: "Vendor management, inventory automation, multi-channel purchasing workflows." },
    { name: "Discount Pool Supply", url: "https://www.discountpoolsupply.com/", desc: "BigCommerce pool-supply store.", features: "Advanced filters, replacement-part discovery, promotional functionality, online checkout." },
    { name: "Kaiser Willys", url: "https://www.kaiserwillys.com/", desc: "Automotive-parts BigCommerce store specializing in vintage Willys Jeeps.", features: "Vehicle-based navigation, Klevu search, personalized product discovery." }
];
...
projects.forEach(p => {
    projectsHTML += `
                <div class="col-md-4 mb-4 project-card reveal" data-category="eCommerce" data-tech="BigCommerce, Stencil">
                    <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden">
                        <div class="d-flex align-items-center justify-content-center" style="height: 180px; background-color: #f1f1f1;">
                            <img src="https://cdn.simpleicons.org/bigcommerce/gray" alt="BigCommerce Logo" style="width: 70px; height: 70px; object-fit: contain;" loading="lazy" decoding="async">
                        </div>
                        <div class="card-body d-flex flex-column text-center p-4">
                            <h5 class="card-title fw-bold mb-2" style="font-family:'Jost', sans-serif;">${p.name}</h5>
                            <p class="small fw-bold" style="color:var(--primary-color);">eCommerce</p>
                            <p class="card-text small text-muted flex-grow-1">Developed with BigCommerce, Stencil API.</p>
                            <div class="mt-4 d-flex justify-content-center w-100 gap-2">
                                ...
                                <button type="button" class="btn btn-primary px-3 rounded-pill site-details-btn"
                                    ...
                                    data-title="${p.name}"
                                    data-desc="${p.desc} Features: ${p.features}"
                                    data-tech="BigCommerce, Stencil" data-url="${p.url}">
...
console.log('Successfully updated bigcommerce-projects.html');
